/*
  This is a slightly modified version of Jose Pereda's gist:
  https://gist.github.com/jperedadnr/28534fcdce605b75382b
  in an IntelliJ IDEA project, including the pallete file image.
*/
...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        String imageName = "resources/palette.png";
        mat.setDiffuseMap(new Image(getClass().getResourceAsStream(imageName)));
